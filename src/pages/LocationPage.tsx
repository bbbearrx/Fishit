/**
 * ═══════════════════════════════════════════════════════════════════════════
 * LOCATION PAGE COMPONENT — REUSABLE TEMPLATE
 * ═══════════════════════════════════════════════════════════════════════════
 * 
 * PURPOSE:
 * Generic location page component that accepts a location name prop.
 * Displays all fish found at that specific location.
 * 
 * USAGE:
 * Used for all 11 location pages by passing the location name as prop.
 */
...
export default function LocationPage({ locationName }: LocationPageProps) {
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              {locationName === "Kohana Volcano" && (
                <div className="inline-block mt-2">
                  <Badge variant="epic" className="bg-orange-500/20 border-orange-500/30 text-orange-400">
                    Updated in Lava Basin Expansion
                  </Badge>
                </div>
              )}
            </div>
